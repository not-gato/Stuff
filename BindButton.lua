...
bindArea.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
...
function screenGui:CreateBindable(name, callback)
    ...
    button.FontFace = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal)
